        ...
        <?php else : ?>
            <?php foreach ($students as $key => $student) : ?>
                <tr>
                    ...
                    <td><img src="<?php echo $student->getImage() ?>" style="width: 55px; height: 65px"/></td>
                    <td>

                        <a href="index.php?page=update-student&id=<?php echo $student->getId(); ?>">
                            <svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-arrow-repeat"
                    ...
                    <td><a href="index.php?page=delete-student&id=<?php echo $student->getId(); ?>">
